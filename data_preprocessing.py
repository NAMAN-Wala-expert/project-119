...
def get_stem_words(words, ignore_words):
    ...
    for word in words:
        ...
        1) lowercase it y
        2) stem it y
        3) append it to stem_words list y
        4) return the list
        ''' 
        # Add code here # 
...
def create_bot_corpus(words, classes, pattern_word_tags_list, ignore_words):
    ...
    for intent in data['intents']:
        ...
        for pattern in intent['patterns']:  
            ...
            pattern_word_tags_list.append(stemwords)
    ...
    stem_words = sorted(list(set(stemwords)))
...
def bag_of_words_encoding(stem_words, pattern_word_tags_list):
    ...
    for word_tags in pattern_word_tags_list:
        ...
        '''
        for i in range(stem_words):
            wordy = stem_words[i]
            if wordy not in stemmed_pattern_word:
                bow_data.append(1)
            else:
                bow_data.append(0)
